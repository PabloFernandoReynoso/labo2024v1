...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = 0.01, #CAMBIO
    feature_fraction = 0.5, #CAMBIO
    num_leaves = 2000L, #CAMBIO
    min_data_in_leaf = 2000L #CAMBIO
  )


  # una Beyesian de Guantes Blancos, solo hace 15 iteraciones
  param_local$bo_iteraciones <- 1 # iteraciones de la Optimizacion Bayesiana #CAMBIO
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-semF003", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-semF003", "DT0001-semF003" )

  DR_drifting_baseline( "DR0001-semF003", "CA0001-semF003" )
  FE_historia_baseline( "FE0001-semF003", "DR0001-semF003" )

  TS_strategy_baseline_202109( "TS0001-semF003", "FE0001-semF003" )

  HT_tuning_baseline( "HT0001-semF003", "TS0001-semF003" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-semF003", c("HT0001-semF003","TS0001-semF003") )
...
corrida_baseline_semillerio_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_baseline_202107( "TS0002-semF003", "FE0001-semF003" )

  HT_tuning_baseline( "HT0002-semF003", "TS0002-semF003" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-semF003", c("HT0002-semF003","TS0002-semF003") )
...
corrida_baseline_semillerio_202109( "basem01F003" )
