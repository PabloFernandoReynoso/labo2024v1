...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = c( 0.01, 0.2 ), #CAMBIO
    feature_fraction = c( 0.5, 0.6 ), #CAMBIO
    num_leaves = c( 1500L, 2500L,  "integer" ), #CAMBIO
    min_data_in_leaf = c( 1700L, 2800L, "integer" ) #CAMBIO
  )


  # una Beyesian de Guantes Blancos, solo hace 15 iteraciones
  param_local$bo_iteraciones <- 50 # iteraciones de la Optimizacion Bayesiana #CAMBIO
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-semF002", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-semF002", "DT0001-semF002" )

  DR_drifting_baseline( "DR0001-semF002", "CA0001-semF002" )
  FE_historia_baseline( "FE0001-semF002", "DR0001-semF002" )

  TS_strategy_baseline_202109( "TS0001-semF002", "FE0001-semF002" )

  HT_tuning_baseline( "HT0001-semF002", "TS0001-semF002" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-semF002", c("HT0001-semF002","TS0001-semF002") )
...
corrida_baseline_semillerio_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_baseline_202107( "TS0002-semF002", "FE0001-semF002" )

  HT_tuning_baseline( "HT0002-semF002", "TS0002-semF002" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-semF002", c("HT0002-semF002","TS0002-semF002") )
...
corrida_baseline_semillerio_202109( "basem01F002" )
