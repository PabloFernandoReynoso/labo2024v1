...
PARAM$semillas <- c(100417, 100547, 100733, 100747, 100829,123401,202127,966439,155219,248879,116959,122449,238529,439199,515741,434411,889891,126517,910031,686911)
...
setwd("C:\\Users\\pablo\\labo2024v1\\") # Establezco el Working Directory
# cargo los datos
