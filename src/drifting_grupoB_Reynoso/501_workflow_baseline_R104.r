...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z531_DR_corregir_driftingR.r"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_R104", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_R104", "DT0001_R104" )

  DR_drifting_guantesblancos( "DR0001_R104", "CA0001_R104" )
  FE_historia_guantesblancos( "FE0001_R104", "DR0001_R104" )

  TS_strategy_guantesblancos_202109( "TS0001_R104", "FE0001_R104" )

  HT_tuning_guantesblancos( "HT0001_R104", "TS0001_R104" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_R104", c("HT0001_R104","TS0001_R104") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_R104", "FE0001_R104" )

  HT_tuning_guantesblancos( "HT0002_R104", "TS0002_R104" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_R104", c("HT0002_R104", "TS0002_R104") )
...
corrida_guantesblancos_202109( "gb01_R104" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_R104" )
